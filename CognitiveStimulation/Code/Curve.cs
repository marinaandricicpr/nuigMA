...
namespace Cognitive_Stimulation
{
    ...
    { 
        ...
        public static Curve CreateHorizontal(int length)
        {
        ...
        public static Curve CreateVertical(int length)
        {
            Curve curve = CreateHorizontal(length);
            curve.Rotate(90);
        ...
        public Curve Translate(int transX, int transY)
        {            
        ...
        public Curve Rotate(int degrees)
        {
